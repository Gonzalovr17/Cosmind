...
// import { ArrowLeft, RotateCcw, Brain, Heart, Moon, Zap, AlertCircle, CheckCircle, Star, Award, Sparkles, TrendingUp } from 'lucide-react';
...
//     // For mixed quiz, create general score ranges
//     if (quizId === 'mixed') {
//       const percentage = (score / 30) * 100; // Assuming max score of 30 for 10 questions
...
//           max: 7,
//           label: 'Low Concern',
//           description: 'Your responses suggest minimal concerns across the assessed areas. Keep maintaining your positive mental health habits!',
//           color: 'green',
//           recommendations: [
...
//           max: 15,
//           label: 'Mild Concerns',
//           description: 'Your responses suggest some areas that could benefit from attention. Consider implementing stress management techniques.',
//           color: 'yellow',
//           recommendations: [
...
//           description: 'Your responses suggest moderate concerns that may benefit from professional support.',
//           color: 'orange',
//           recommendations: [
...
//           description: 'Your responses suggest significant concerns. We recommend seeking professional support.',
//           color: 'red',
//           recommendations: [
...
//     switch (color) {
//       case 'green':
//         return <Star className="w-7 h-7 text-emerald-500 animate-gentle-pulse" />;
//       case 'yellow':
//         return <Sparkles className="w-7 h-7 text-amber-500 animate-gentle-pulse" />;
//       case 'orange':
//         return <TrendingUp className="w-7 h-7 text-orange-500 animate-gentle-pulse" />;
//       case 'red':
//         return <Heart className="w-7 h-7 text-rose-500 animate-gentle-pulse" />;
//       default:
//         return <Award className="w-7 h-7 text-blue-500 animate-gentle-pulse" />;
//     }
//   };
...
//   return (
//     <div className="min-h-screen bg-black p-4 py-8 flex items-center justify-center relative overflow-hidden text-gray-100">
//       {/* Floating galaxy-style blurred orbs (colorful version) */}
...
//                 <div
//                   key={result.quizId}
//                   className="bg-gray-900/80 backdrop-blur-md rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-700 transform hover:scale-102 overflow-hidden animate-slide-up border border-gray-700"
//                   style={{ animationDelay: `${index * 200}ms` }}
//                 >
//                   {/* Friendly Header */}
//                   <div
//                     className={`bg-gradient-to-r ${colorMap[quiz.color] || colorMap.gray} p-6 relative overflow-hidden`}
//                   >
//                     {/* Decorative elements */}
...
//                             <IconComponent className="w-8 h-8 text-gray-300 drop-shadow-md" />
//                           </div>
//                           <div>
//                             <h3 className="text-2xl font-bold text-gray-200 drop-shadow-sm">{quiz.title}</h3>
//                             <p className="text-gray-400 text-sm font-medium drop-shadow">{`Completed ${result.completedAt.toLocaleDateString()}`}</p>
//                           </div>
//                         </div>
...
//                         <p className="text-gray-200 font-medium text-center drop-shadow">{getEncouragingMessage(scoreRange.color)}</p>
//                       </div>
//                     </div>
//                   </div>
...
//                       <div className="bg-gradient-to-r from-gray-900 to-black rounded-2xl p-4 shadow-inner border border-gray-800">
//                         <div className="grid grid-cols-3 items-center gap-4">

//                           {/* Icon */}
//                           <div className="flex justify-center text-4xl">
//                             {getScoreEmoji(scoreRange.color)}
//                           </div>
...
//                             <div
//                               className={`text-xl font-bold ${scoreRange.color === 'green'
//                                 ? 'text-emerald-400'
...
//                     <div className="bg-gradient-to-br from-black/40 to-black/60 rounded-2xl p-5 mb-6 border border-gray-700">
//                       <p className="text-gray-300 leading-relaxed font-medium">{scoreRange.description}</p>
//                     </div>

//                     {/* Supportive Recommendations */}
//                     {scoreRange.recommendations && (
//                       <div className="bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl p-5 border border-gray-600">
//                         <div className="flex items-center space-x-2 mb-3">
//                           <Heart className="w-5 h-5 text-gray-400" />
//                           <h4 className="font-bold text-gray-300">Gentle Suggestions for You:</h4>
//                         </div>
//                         <ul className="space-y-3">
//                           {scoreRange.recommendations.map((rec, idx) => (
//                             <li key={idx} className="text-gray-300 flex items-start font-medium">
...
//         {/* Supportive Notice */}
//         <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-l-4 border-gray-600 rounded-2xl p-8 mb-8 animate-fade-in shadow-lg drop-shadow-md">
//           <div className="flex items-start">
//             <div className="bg-gray-700 rounded-full p-2 mr-4 mt-1 flex-shrink-0">
//               <Heart className="w-6 h-6 text-gray-200 drop-shadow-md" />
//             </div>
//             <div>
//               <h3 className="font-bold text-gray-300 mb-3 text-lg drop-shadow-sm">A Gentle Reminder 💙</h3>
//               <p className="text-gray-400 leading-relaxed drop-shadow-sm">
//                 These assessments are like a friendly check-in with yourself - they're here to help guide you, not define you. You are so much more than any score! If you're feeling overwhelmed or need someone to talk to, reaching out to a mental health professional is a beautiful act of self-care. You deserve support and kindness! 🌟
//               </p>
//             </div>
//           </div>
//         </div>
...
const ResultsScreen = ({ results, onBackToWelcome, onStartOver, scoreData, onBack }) => {
  ...
  //             >
  //               {/* Header */}
  //               <div className={`bg-gradient-to-r ${gradientMap[quiz.color] || gradientMap.gray} p-4 relative overflow-hidden`}>
  ...
  //       {/* Supportive Notice */}
  //       <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-l-4 border-gray-600 rounded-2xl p-6 mb-8 animate-fade-in shadow-lg drop-shadow-md">
  //         <div className="flex items-start">
  //           <div className="bg-gray-700 rounded-full p-2 mr-4 mt-1 flex-shrink-0">
  //             <Heart className="w-6 h-6 text-gray-200 drop-shadow-md" />
  //           </div>
  ...
  //             <h3 className="font-bold text-gray-300 mb-3 text-lg drop-shadow-sm">A Gentle Reminder 💙</h3>
  //             <p className="text-gray-400 leading-relaxed drop-shadow-sm">
  //               These assessments are like a friendly check-in with yourself - they're here to help guide you, not define you. You are so much more than any score! If you're feeling overwhelmed or need
  //               someone to talk to, reaching out to a mental health professional is a beautiful act of self-care. You deserve support and kindness! 🌟
  //             </p>
  //           </div>
  //         </div>
  //       </div>
